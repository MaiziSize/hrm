            ...
            $.ajax({
                ...
                success : function(data){
                    $.each(data, function(){
                        ...
                        option.attr("selected", this.id == "${emp.job.id}" ? true : false);
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	...
		    	<table>
		    		...
		    		<tr>
		    			...
		    			<td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：<select  name="job.id" id="jobId"></select></td>
		    		</tr>
		    		<tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					name="birthday" id="birthday" size="40" value="<fmt:formatDate value="${emp.birthday}" pattern="yyyy-MM-dd"/>"/>&nbsp;&nbsp;
			...
			<tr>
				<td class="font3 fftd">
					...
					<%--<c:if test="${emp.dept.id eq dept.id}">--%>
                    <option value="${dept.id}"> ${dept.name}</option>
					<%--</c:if>--%>
                    </c:forEach>
					<option selected="${emp.dept.id}"> ${emp.dept.name}</option>
