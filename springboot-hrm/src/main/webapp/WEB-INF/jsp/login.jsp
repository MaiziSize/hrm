			  ...
			  <div class="login_main_tab">
			    ...
			    <div class="log_main_t_mid">
					...
					<form  method="post" id="loginForm" >
					  <div class="log_input">用户名:<input type="text" id="name" name="name" value="jiangke" size="20" ></div>
					  <div class="log_input">密　码:<input type="password" id="password" value="815646353" name="password" ></div>
					  <div class="log_input">
					  	<table><tr>
