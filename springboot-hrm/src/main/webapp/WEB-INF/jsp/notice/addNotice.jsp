	...
	<head>
		...
		<script type="text/javascript">
			tinyMCE.init({
				...
				language : "zh-cn", // 语言: 国际化 language :"zh-cn"
				// 指定工具文件夹
		  	...
		  	<tr valign="top">
			    <td>
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
				  	<!-- 表单 -->
				  	<form action="/notice/addNotice" method="post" theme="simple" id="noticeForm">

					    <tr><td class="font3 fftd">公告标题：<input type="text" name="title" id="title" size="30" />
					    	</td>
					    </tr>
						...
						<tr><td class="font3 fftd">公告内容：<br/>
							<input rows="11" cols="88" name="content" id="content"></input>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
